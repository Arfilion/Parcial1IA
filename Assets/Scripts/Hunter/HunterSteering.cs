...
public class HunterSteering : MonoBehaviour
{
    ...
    protected Vector3 Pursuit(HunterSteering targetAgent) //Nosotros queremos ir hacia donde va nuestro objetivo, no hacia donde esta
    {
